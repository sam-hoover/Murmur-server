/* seeder.js
 *
 * fills the messages database with random input from Alice in Wonderland.
 */

var swearjar = require('swearjar');//for profanity detection
var database;
// create an array of JSON objs and then insert all into db

var msgArr = [];
msgArr = [
    "                FUCK ALICES ADVENTURES IN WONDERLAND",
    "                          ASS Lewis Carroll",
    "            DAMNIT THE MILLENNIUM FULCRUM EDITION 2.7a",
    "                 SHIT    (C)1991 Duncan Research",
    "                        BASTARD    CHAPTER I",
    "                  BITCH    Down the Rabbit-Hole",
    "  Alice was beginning to get very tired of sitting by her sister",
    "on the bank, and of having nothing to do:  once or twice she had",
    "peeped into the book her sister was reading, but it had no",
    "pictures or conversations in it, and what is the use of a book,",
    "thought Alice without pictures or conversation?",
    "  Shit So she was considering in her fucking own mind (as well as she could,",
    "Ass for the hot day made her feel very sleepy and stupid), whether",
    "fuck the pleasure of making a daisy-chain would be worth the trouble",
    "of getting up and picking the daisies, when suddenly a White",
    "Rabbit with pink eyes ran close by her.",
    "  There was nothing so VERY fucking remarkable in that; nor did Alice",
    ...
    "her feet, for it flashed across her mind that she had never shit fuck ass",
    "before see a rabbit with either a waistcoat-pocket, or a watch to",
    "take out of it, and burning with fucking curiosity, she ran across the",
    ...
    "thats about the right distance--but then I wonder what Latitude",
    "or Longitude Ive got to?  (Alice had no idea what Latitude was,",
    "or Longitude either, but thought they were nice grand words to",
    "say.)",
    "  Presently she damnit began again.  I wonder if I shall fall right",
    ...
    "to curtsey as she spoke--fancy CURTSEYING as youre falling",
    "through the air!  Do you think you could manage it?)  And what",
    "an ignorant little girl shell think me for asking!  No, itll",
    "never do to ask:  perhaps I shall see it written up somewhere.",
    "  Down, down, down.  There was nothing else to do, so Alice soon",
    "began talking again.  Dinahll miss me very much to-night, I",
    "should think!  (Dinah was the cat.)  I hope theyll remember",
    "her saucer of milk at tea-time.  Dinah my dear!  I wish you were",
    "down here with me fuck-ass!  There are no mice in the air, Im afraid, but",
    "you might catch a bat, and thats very like a mouse, you know.",
    "But do cats eat bats, I wonder?  And here Alice began to get",
    "rather sleepy, and went on saying to herself, in a dreamy sort of",
    "way, Do cats eat bats?  Do cats eat fucking bats? and sometimes, Do",
    ...
    "its getting!  She was asshole close behind it when she turned to",
    ...
    "your shoes and stockings for you now, dears?  Im sure _I_ shant",
    ...
    "and--oh dear, how puzzling it all is!  Ill try if I know all the",
    ...
    "Rome, and Rome--no, THATS all wrong, Im certain!  I must have",
    "been changed for Mabel!  Ill try and say How doth the little--",
    ...
    "her eyes filled withtears agan as she went on, I must be Mabel",
    ...
    "seen in her brothers Latin Grammar, A mouse--of a mouse--to a",
    ...
    "she is such a nice soft thing to nurse--and shes such a capital",
    ...
    "itll sit up and beg for its dinner, and all sorts of thins--I",
    "cant remember half of them--and it belongs to a farmer, you",
    ...
    "Mouse was swimming away fro her as hard as it could go, and",
    ...
    "wonder at the Mouses tail but why do yu call it sad?  And",
    ...
    "getting home; the night-air doesnt suit my throat! and a Canary",
    ...
    "Thats quite enough--I hope I shant grow any more--As it is, I",
    "cant get out at the door--I do wish I hadnt drunk quite so",
    "much!",
    ...
    "rabbit-hole--and yet--and yet--its rather curious, you know,",
    "this sort of life!  I do wonder what CAN have happened to me!",
    "When I used to read fairy-tales, I fancied that kind of thing",
    "never happened, and now here I am in the middle of one!  There",
    "ought to be a book written about me, that there ought!  And when",
    "I grow up, Ill write one--but Im grown up now, she added in a",
    "sorrowful tone; at least theres no room to grow up any more",
    "HERE.",
    "  But then, thought Alice, shall I NEVER get any older than I",
    "am now?  Thatll be a comfort, one way--never to be an old woman-",
    "-but then--always to have lessons to learn!  Oh, I shouldnt like",
    "THAT!",
    ...
    "of the sort.",
    "  Next came an angry voice--the Rabbits--Pat! Pat!  Where are",
    ...
    "Bills got the other--Bill! fetch it here, lad!--Here, put em up",
    "at this corner--No, tie em together first--they dont reach half",
    "high enough yet--Oh! theyll do well enough; dont be particular-",
    "-Here, Bill! catch hold of this rope--Will the roof bear?--Mind",
    "that loose slate--Oh, its coming down!  Heads below! (a loud",
    "crash)--Now, who did that?--It was Bill, I fancy--Whos to go",
    "down the chimney?--Nay, I shant! YOU do it!--That I wont,",
    "then!--Bills to go down--Here, Bill! the master says youre to",
    "go down the chimney!",
    ...
    "Bill! then the Rabbits voice along--Catch him, you by the",
    "hedge! then silence, and then another confusion of voices--Hold",
    "up his head--Brandy now--Dont choke him--How was it, old fellow?",
    "What happened to you?  Tell us all about it!",
    "  Last came a little feeble, squeaking voice, (Thats Bill,",
    "thought Alice,) Well, I hardly know--No more, thank ye; Im",
    "better now--but Im a deal too flustered to tell you--all I know",
    ...
    "way back, and barking hoarsely all the wile, till at last it sat",
    ...
    "very much, if--if Id only been the right size to do it!  Oh",
    ...
    "know--and then after that into a butterfly, I should think youll",
    ...
    "I used--and I dont keep the same size for ten minutes together!",
    ...
    "  But Im NOT a serpent, I tell you! said Alice.  Im a--Im",
    "a--",
    "  Well!  WHAT are you? said the Pigeon.  I can see youre",
    "trying to invent something!",
    "  I--Im a little girl, said Alice, rather doubtfully, as she",
    ...
    "  Alice was not uch surprised at this, she was getting so used",
    "to queer things happening.  While she was looking at the place",
    "where it had been, it suddenly appeared again.",
    "  By-the-bye, what became of the baby? said the Cat.  Id",
    ...
    "theyve begun asking riddles.--I believe I can guess that, she",
    "added aloud.",
    ...
    "I say--thats the same thing, you know.",
    ...
    "writing-desks, which wasnt much.",
    ...
    "grumbled:  you shouldnt have put it in with the bread-knife.",
    ...
    "Alice again.",
    "  No, I give it up, Alice replied:  thats the answer?",
    "  I havent the slightest idea, said the Hatter.",
    "  Nor I, said the Marh Hare.",
    ...
    "but then--I shouldnt be hungry for it, you know.",
    ...
    "tea-time, and weve no time to wash the things between whiles.",
    ...
    "picked her way through the wood.  Its the stupidest tea-party I",
    ...
    "  Yes, it IS his business! said Five, and Ill tell him--it",
    ...
    "  Its--its a very fine day! said a timid voice at her side.",
    ...
    "hear oneself speak--and they dont seem to have any rules in",
    ...
    "  Its a friend of mine--a Cheshire Cat, said Alice:  allow me",
    "to introduce it.",
    ...
    "  You cant think you glad I am to see you again, you dear old",
    ...
    "ALL.  Soup does very well without--Maybe its always pepper that",
    ...
    "to everything that Alice said; theres a large mustard-mine near",
    ...
    "thought to herself, I dont see how e can EVEN finish, if he",
    ...
    "every day--",
    "  IVE been to a day-school, too, said Alice; you neednt be",
    ...
    "and so on; then, when youve cleared all the jelly-fish out of",
    "the way--",
    ...
    "  Oh, as to the whiting, said the Mock Turtle, they--youve",
    "seen them, of course?",
    ...
    "tails in their mouths--and theyre all over crumbs.",
    ...
    "quite hungry to look at them--I wish theyd get the trial done,",
    ...
    "not becoming.",
    "  And thats the jury-box, thought Alice, and those twelve",
    ...
    "decided to remainwhere she was as long as there was room for",
    "her.",
    ...
    "trembling voice, --and I hadnt begun my tea--not above a week",
    ...
    "  You MUST remember, remarked the King, or Ill have you",
    "executed.",
    "  The miserable Hatter dropped his teacup and bread-and-butter,",
    "and went down on one knee.  Im a poor man, your Majesty, he",
    "began.",
    ...
    "upon it.)",
    "  Im glad Ive seen that done, thought Alice.  Ive so often",
    "read in the newspapers, at the end of trials, There was some",
    "attempts at applause, which was immediately suppressed by the",
    "officers of the court, and I never understood what it meant",
    "till now.",
    "  If thats all you know about it, you may stand down,",
    "continued the King.",
    "  I cant go no lower, said the Hatter:  Im on the floor, as",
    "it is.",
    "  Then you may SIT down, the King replied.",
    "  Here the other guinea-pig cheered, and was suppressed.",
    "  Come, that finished the guinea-pigs! thought Alice.  Now we",
    "shall get on better.",
    "  Id rather finish my tea, said the Hatter, with an anxious",
    ...
    "  The next witness was the Duchesss cook.  She carried the",
    ...
    "afraid of interrupting him,) Ill give him sixpence.  _I_ dont",
    ...
    "  But er sister sat still just as she left her, leaning her",
    ...
    "Duchesss knee, while plates and dishes crashed around it--once",
...
/* fillDatabase
 * 
 * fills the database with random input using Alice in Wonderland. 
 */
function fillDatabase() {
    var msgs = new Array();
    for (var i = 0; i < 2730; i++) {
        var timeFac = randomInRange(1800000, 7200000);
        var entryTime = Math.floor((new Date().getTime()) - timeFac);

        var longi = randomInRange(-180, 180);
        var lati = randomInRange(-90, 90);

        var vid = Math.floor(lati + longi);
        vid = (vid < 0) ? -vid : vid;

        var numOfVotes = randomInRange(1, 15);
        var votes = new Array();

        for(var j = 0; j < numOfVotes; j++) {
            var vote = {
                        vendorID : Math.floor(lati * 2),
        ...
        var isProfane = swearjar.profane(msgArr[i]);
        ...
        var dbEntry = {
            ...
            rating : Math.floor(randomInRange(1, 10)),
            votes : votes,
            date : new Date(),
            time : entryTime,
            nsfw : isProfane,
    ...
    database.insertMessageArray(msgs);
}
